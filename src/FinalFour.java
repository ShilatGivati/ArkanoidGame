...
public class FinalFour implements LevelInformation {
    ...
    private static final int NUMBER_OF_BLOCKS_TO_REMOVE = 90;
    ...
    //Blocks.
    private static final double BLOCK_WIDTH = 49.25;
    private static final int BLOCK_HEIGHT = 25;
    private static final int NUMBER_OF_ROWS = 6;
    private static final int BLOCKS_IN_ROW = 15;
    private static final int BLOCK_X_START = 30;
    ...
    public List<Velocity> initialBallVelocities() {
        ...
        velocity.add(Velocity.fromAngleAndSpeed(0, SPEED));
